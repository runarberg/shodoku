    ...
    (
      ...
      FROM (
        ...
        INNER JOIN word_meaning_glossary
          ON word_meaning_glossary.meaning = word_meanings.id
          AND word_meaning_glossary.word = word_meanings.word
        OUTER LEFT JOIN
          (
            SELECT word, meaning, json_group_array(writing) as writings
        ...
        OUTER LEFT JOIN
          (
            SELECT word, meaning, json_group_array(reading) as readings
